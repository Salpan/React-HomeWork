...
import { EffectorWrapper, Header, ThemeButton } from "./components/styledComponents"
...
export const EffectorPage = () => {
    ...
    return (
        <EffectorWrapper theme={theme}>
            ...
            <ThemeButton type="button" theme={theme} onClick={handleThemeChange}>
                <ThemeIcone />
            </ThemeButton>
            <LikesCounter />
            <div className="effector-commentary-wrapper">
                ...
                {comments.map((comment) => {
                    return (
                        <Commentary theme={theme} commentId={comment.id} key={comment.id}
